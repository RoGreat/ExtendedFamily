...
{
	public class EncyclopediaFamilyTreeNodeItemWidget : BrushWidget
	{
		...
		public EncyclopediaFamilyTreeNodeItemWidget(UIContext context) : base(context)
		{
		...
		{
			BrushWidget brushWidget = new BrushWidget(Context)
			{
